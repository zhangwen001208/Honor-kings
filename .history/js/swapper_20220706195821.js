...
adbtnEl.onmouseover = function(event) {
   ...
   //这里计算一个下标 index来拿到 点击那个item就让那个item的下标传给index
    ...
    console.log(index)
    swapperEl.style.transform = `translateX(${- 604 * index}px)`;
    console.log(swapperEl.style.transform)
    swapperEl.style.transition = `all 300ms ease`
    cuurntIndex = index
    console.log(cuurntIndex)
}
